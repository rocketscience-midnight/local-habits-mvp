/**
 * Info View - Help text (inline) + Statistics combined
 */

import { renderStats } from './stats.js';

export async function renderInfo(container) {
  // Help section (inline, not modal)
  const helpSection = document.createElement('div');
  helpSection.className = 'info-help-section';
  ...
  statsSection.className = 'info-stats-section';
  await renderStats(statsSection);
